...
void n32_msp_spi_init(void *Instance)
{
    ...
    if(SPI1 == SPIx)
    {
        ...
        GPIO_InitCtlStruct.Pin = GPIO_PIN_4 |GPIO_PIN_0|GPIO_PIN_2|GPIO_PIN_1;//SPI1_NSS
        GPIO_InitPeripheral(GPIOA, &GPIO_InitCtlStruct);
        GPIO_InitCtlStruct.GPIO_Mode = GPIO_Mode_AF_PP;
        GPIO_InitCtlStruct.Pin = GPIO_PIN_5 | GPIO_PIN_7;//SPI1_SCK|SPI1_MOSI
        GPIO_InitPeripheral(GPIOA, &GPIO_InitCtlStruct);
        GPIO_InitCtlStruct.GPIO_Mode = GPIO_Mode_IN_FLOATING;
        GPIO_InitCtlStruct.Pin = GPIO_PIN_6;//SPI1_MISO
        GPIO_InitPeripheral(GPIOA, &GPIO_InitCtlStruct);
    }
#endif
